...
module.exports = biojsvissummaryhorizontalbargraph = function(init_options)
{
    ...
    this.setup_y_axis = function(graph){
        ...
        */
        var scaleY = d3.scale.linear()
            .range([page_options.height + page_options.gap_between_groups, 0]);
    ...
    this.setup_x_axis = function (graph){
        ...
        gap_at_end_of_graph= options.gap_at_end_of_graph;
        ...
        var scaleX = d3.scale.linear()
            ...
            .range([0, width - horizontal_space_for_labels - gap_at_end_of_graph]);
    ...
    this.setup_bar = function(graph){
        ...
        initial_gap_from_top_and_bottom = 10; // this is the gap between the bars and the box around it
        bar_height = (page_options.height - 2*initial_gap_from_top_and_bottom)/(data.length);
        ...
        var bar = svg.selectAll("g")
            ...
            .attr("transform", function(d, i) {
                test = d;
                return "translate(" + horizontal_space_for_labels + "," + ((i * bar_height) + initial_gap_from_top_and_bottom) + ")";
            });
